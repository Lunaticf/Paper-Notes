...
回到文章的本来的标题，Design for trust:An Exploration of the Chanllenges and Opportunities of Bitcoin users。
这篇文章可能更多的篇幅在后半部分，探索比特币用户的机会和挑战，和他们使用比特币的动机、如何信任交易对方。最后提出的一些设计方面的启示是为了增强信任，呼应Design for trust.
